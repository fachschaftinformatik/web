...
import type { ExamListEntry, Program, Module } from "@lib/api";
...
export default function ExamDetailsPage() {
  ...
  useEffect(() => {
    ...
    let active = true;
    getExamsFile({ path: { id: selectedExam.id } })
        .then(({ data }) => {
            if (active && data) {
                        ...
                        <Stack spacing={2}>
                            ...
                            <Stack direction="row" spacing={2}>
                                <TextField 
                                    ...
                                    size="small"
                                >
                                    {formProgram?.versions.map((v) => (<MenuItem key={v} value={v}>{v}</MenuItem>))}
                                </TextField>
