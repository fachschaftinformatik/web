 ...
 */
export const getAdminDashboard = <ThrowOnError extends boolean = false>(options?: Options<GetAdminDashboardData, ThrowOnError>) => (options?.client ?? client).get<GetAdminDashboardResponses, unknown, ThrowOnError>({ url: '/admin/dashboard', ...options });
 ...
 */
export const getAdminStats = <ThrowOnError extends boolean = false>(options?: Options<GetAdminStatsData, ThrowOnError>) => (options?.client ?? client).get<GetAdminStatsResponses, unknown, ThrowOnError>({ url: '/admin/stats', ...options });
